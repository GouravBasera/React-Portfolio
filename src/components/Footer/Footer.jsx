      ...
      <div className="mt-20 w-[80%] flex mx-auto">
        <div className="w-[50%] h-[90vh]">
          ...
          <p className="text-[#C7C7C7] text-lg mb-10">
            ...
            <span className="text-decoration-line: underline">resume</span>
          </p>
        ...
        <div className="w-[50%] text-[#C7C7C7] h-[90vh]">
          <form className="flex flex-col gap-y-2">
            ...
            <input className="mb-6 rounded outline-none px-4 py-3 bg-[#1A1A1A]" type="text" id="name" />
            <label htmlFor="email">Email</label>
            <input className="mb-6 rounded outline-none px-4 py-3 bg-[#1A1A1A]" type="text" id="email" />
            <label htmlFor="subject">Subject</label>
            <input className="mb-6 rounded outline-none px-4 py-3 bg-[#1A1A1A]" type="text" id="subject" />
            <label htmlFor="message">Message</label>
            <textarea className="mb-6 resize-none rounded outline-none px-4 py-3 bg-[#1A1A1A] h-[156px]" type="text" id="message" />
